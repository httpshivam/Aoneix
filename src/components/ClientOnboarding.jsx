...
export default function ClientOnboarding({ onBack, onComplete, showToast }) {
  ...
  const [metaVerified, setMetaVerified] = useState("I don't know");
          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-300">
            ...
            <div className="grid grid-cols-3 gap-2.5 sm:gap-4 md:gap-5">
              ...
              <div 
                ...
                className={`cursor-pointer rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-5 flex flex-col items-center justify-center text-center transition-all relative border-2 ${
              ...
              >
                ...
                <span className="text-xs sm:text-sm font-bold text-gray-900 truncate max-w-full">WhatsApp</span>
              </div>
              ...
              >
                ...
                <span className="text-xs sm:text-sm font-bold text-gray-900 truncate max-w-full">Instagram</span>
              </div>
              ...
              >
                ...
                <span className="text-xs sm:text-sm font-bold text-gray-900 truncate max-w-full">Messenger</span>
              </div>
