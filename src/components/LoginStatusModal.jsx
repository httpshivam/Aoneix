...
export default function LoginStatusModal({
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative w-full max-w-[360px] sm:max-w-[390px] rounded-2xl p-4 sm:p-6 overflow-hidden bg-white border border-black shadow-2xl transition-all animate-modal-spring ${!isSuccess ? 'animate-warning-shake' : ''
          }`}
        onClick={(e) => e.stopPropagation()}
      >
        {/* Soft Ambient Radiant Background Glow at the Top */}
        <div
          className={`absolute -top-16 left-1/2 -translate-x-1/2 w-48 h-48 rounded-full blur-[45px] pointer-events-none ${isSuccess
        ...
        <div className="relative flex flex-col items-center justify-center pt-1 pb-2">
          ...
          <div className="relative flex items-center justify-center animate-orb-float">
            ...
            <div
              className={`w-[72px] h-[72px] rounded-full relative overflow-hidden flex items-center justify-center border border-white/90 ${isSuccess
            ...
            >
              ...
              <div
                className={`absolute inset-0 rounded-full pointer-events-none opacity-95 ${isSuccess
          ...
          <div
            className={`w-12 h-1 rounded-[100%] blur-[2px] mt-1.5 pointer-events-none ${isSuccess ? 'bg-emerald-950/20' : 'bg-rose-950/25'
              }`}
          />
        </div>
        ...
        <div className="text-center mt-2 space-y-1.5">
          ...
          {/* Headline */}
          <h3 className="text-lg sm:text-2xl font-extrabold text-gray-950 tracking-tight">
          ...
          <div
            className={`mt-2.5 p-2.5 sm:p-3 rounded-xl text-left text-xs border ${isSuccess
          ...
          {isSuccess ? (
            <>
              ...
              <button
                type="button"
                onClick={onContinue}
                className="w-full py-2 sm:py-2.5 px-4 rounded-lg bg-gradient-to-r from-[#00c25a] to-[#075e37] hover:from-[#00b050] hover:to-[#054c2c] active:scale-[0.99] text-white font-semibold text-xs sm:text-sm shadow-sm flex items-center justify-center gap-2 transition-all cursor-pointer"
              >
            ...
            <>
              ...
              <button
                type="button"
                onClick={onClose}
                className="w-full py-2 sm:py-2.5 px-4 rounded-lg bg-gray-950 hover:bg-black active:scale-[0.99] text-white font-semibold text-xs sm:text-sm shadow-sm flex items-center justify-center gap-2 transition-all cursor-pointer"
              >
              ...
              <button
                ...
                className="w-full py-1.5 sm:py-2 px-4 rounded-lg text-xs font-semibold text-emerald-800 hover:text-emerald-950 hover:bg-emerald-50/70 border border-emerald-200/80 transition-colors flex items-center justify-center gap-1.5 cursor-pointer"
              >
